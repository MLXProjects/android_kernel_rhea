...
#if defined (CONFIG_MACH_RHEA_SS_CORSICA)
#define USB_PHY_RENSITIVITY_OFFSET USB_PHY_RENSITIVITY_94_67
#elif defined (CONFIG_MACH_RHEA_SS_IVORY) || defined(CONFIG_MACH_RHEA_SS_NEVIS) || defined(CONFIG_MACH_RHEA_SS_NEVISP) || defined(CONFIG_MACH_RHEA_SS_NEVISDS)||  defined(CONFIG_MACH_RHEA_SS_CORSICASS)
